...
header {
    background-color: #4444; /* Green background color */
    color: white; /* Text color */
...
.footer {
    background-color: #dddd; /* shaded white */
    color: white; /* Text color */
    text-align: center;
    padding: 1rem 0;
    position: fixed;
